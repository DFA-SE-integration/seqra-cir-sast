...
class CIRFactAwareConditionEvaluator (
    ...
    private var remainingExpr: CIRMarkAwareConditionExpr? = null
    private val evaluatedFacts = mutableListOf<EvaluatedFact>()

    override fun evalWithAssumptionsCheck(condition: CIRMarkAwareConditionExpr): Boolean {
    ...
    override fun assumptionExpr(): CIRMarkAwareConditionExpr? =
